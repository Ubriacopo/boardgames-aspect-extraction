...
class BggRetrieverService:
    ...
    def __init__(self, game_list_csv_path: str = "../resources/2024-08-18.csv"):
    ...
    def get_current(self):
        if self.current_game_index == -1:
            raise ValueError(f"Next wasn't loaded as current_index:{self.current_game_index}")
    ...
    def has_next(self):
        return len(self.games_dataframe) > self.current_game_index + 1
